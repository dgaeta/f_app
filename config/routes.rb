FApp::Application.routes.draw do
 ...
 #Landing page routes
  ...
  match "signin_twitter", :to => "users#create_twitter_user", :via => "post"
  match "create_twitter_user", :to => "users#signin_twitter", :via => "post"
 ...
 get "accept_friend" => "friendships#accept_friend", :as => "accept_friend"
 ...
 match "accept_friend", :to => "friendships#accept_friend", :via => "post" 
