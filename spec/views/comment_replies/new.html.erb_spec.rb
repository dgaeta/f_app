...
describe "comment_replies/new" do
  before(:each) do
    assign(:comment_reply, stub_model(CommentReply,
      :comment_id => "",
  ...
  it "renders new comment_reply form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", comment_replies_path, "post" do
